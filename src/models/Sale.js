...
const SaleSchema = new mongoose.Schema({
  ...
  discountApprovalId: { type: String, default: '', index: true },
  discountApprovedByName: { type: String, default: '' },
  discountApprovedByRole: { type: String, default: '' },
  discountApprovedAt: { type: Date },
  discountCompletedByName: { type: String, default: '' },
  discountCompletedByRole: { type: String, default: '' },
  discountCompletedAt: { type: Date },
