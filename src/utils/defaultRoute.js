...
const ROUTE_CANDIDATES = [
  ...
  { path: '/warehouse-approvals', feature: 'pages.warehouse.approvals', roles: ['Admin', 'Manager', 'Director', 'SuperAdmin'], grant: ['view_warehouse_approvals', 'approve_warehouse_director', 'approve_warehouse_manager'] },
  ...
  { path: '/approvals-center', feature: 'modules.approvalsCenter', roles: ['Admin', 'Manager', 'Director', 'SuperAdmin'], grant: ['view_approvals', 'approve_retail_director', 'approve_retail_manager', 'approve_distribution_director', 'approve_distribution_manager', 'approve_warehouse_director', 'approve_warehouse_manager', 'approve_credit_director', 'approve_credit_manager'] },
  { path: '/refund-approvals', feature: 'modules.refundApprovals', roles: ['Admin', 'Manager', 'Director', 'SuperAdmin'], grant: ['approve_refunds', 'approve_retail_director', 'approve_retail_manager', 'approve_distribution_director', 'approve_distribution_manager', 'approve_warehouse_director', 'approve_warehouse_manager'] },
