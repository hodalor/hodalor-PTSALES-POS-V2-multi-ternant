export const TENANT_GRANT_KEYS = [
  ...
  'view_agent_price', 'view_sales', 'add_sales', 'backdate_sales', 'reset_own_password', 'view_products', 'view_distribution_products', 'view_warehouse_products', 'add_products', 'edit_products',
