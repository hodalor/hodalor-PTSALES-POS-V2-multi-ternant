        ...
        <ul>
          ...
          <li>Chat:
            <ul>
              ...
              <li>Config Settings now has Communication Sounds where users can choose Message Sound and Call Sound, including Off, Soft, Classic, or Bright.</li>
              <li>Use Test Message Sound and Test Call Sound in Config Settings to preview the selected sounds before saving.</li>
              ...
              <li>Incoming calls play a ringing tone, the caller also hears a ringing progress tone, active calls show a duration timer, and recent call history shows missed, rejected, busy, cancelled, and completed calls.</li>
            </ul>
          </li>
          <li>Ask PT AI:
            <ul>
