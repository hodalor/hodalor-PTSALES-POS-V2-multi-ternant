        ...
        >
          <div style={{ display: 'grid', gap: 12 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 }}>
              ...
              <div><div style={{ color: '#94a3b8', fontSize: 12 }}>{t('Initiator')}</div><strong>{(selectedRow.initiatedByName || selectedRow.initiatorName) ? `${selectedRow.initiatedByName || selectedRow.initiatorName}${(selectedRow.initiatedByRole || selectedRow.initiatorRole) ? ` (${selectedRow.initiatedByRole || selectedRow.initiatorRole})` : ''}` : '—'}</strong></div>
