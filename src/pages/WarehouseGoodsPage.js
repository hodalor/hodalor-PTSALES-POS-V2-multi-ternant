  ...
  return (
    <div className="goods-page-shell">
      <div className="card goods-page-header">
        <div>
          <h1 className="goods-page-title">Warehouse Goods</h1>
          <div className="goods-page-subtitle">Browse products available in the active warehouse branch with tighter cards, smaller text, and contained product images.</div>
        </div>
        ...
        <div className="goods-card-grid">
          {rows.map(product => (
            <div key={product.id} className="goods-item-card">
              ...
              <div className="goods-item-line"><strong>Warehouse Stock ({activeBranch?.name || activeBranchId || 'Branch'}):</strong> {product.warehouseStock}</div>
              ...
              <div className="goods-item-line"><strong>Low Stock Threshold:</strong> {product.warehouseLowStock}</div>
