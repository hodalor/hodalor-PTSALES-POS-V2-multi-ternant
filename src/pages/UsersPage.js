...
function UsersPage() {
  ...
  const defaultsForRole = useCallback((r) => {
    ...
    if (rl === 'admin') return [
      'view_dashboard','view_dashboard_cashier_assigned','view_dashboard_cashier_all','view_dashboard_branch_comparison_assigned','view_dashboard_branch_comparison_all','view_pos','view_wholesale_pos','view_warehouse_pos','view_retail_price','view_wholesale_price','view_agent_price','view_sales','add_sales','backdate_sales','reset_own_password','view_products','view_distribution_products','view_warehouse_products','add_products','edit_products','view_inventory','edit_inventory','view_serialized_inventory','view_labels','view_purchases','add_purchases','add_wholesale_purchases','add_warehouse_purchases','edit_purchases','approve_purchases','view_transfers','add_transfers','add_wholesale_transfers','add_warehouse_transfers','edit_transfers','approve_transfers','view_adjustments','add_adjustments','add_wholesale_adjustments','add_warehouse_adjustments','edit_adjustments','approve_adjustments','view_suppliers','add_suppliers','edit_suppliers','view_customers','add_customers','edit_customers','view_finance_reconciliation','add_finance_reconciliation','view_finance_reconciliation_all_branches','manage_finance_accounts','approve_finance_reconciliation_director','approve_finance_reconciliation_manager','view_chat','send_chat_messages','view_pt_ai','view_credit_control','approve_credit_director','approve_credit_manager','view_credit_repayment_approvals','view_approvals','approve_discount_sales','approve_retail_director','approve_retail_manager','approve_distribution_director','approve_distribution_manager','approve_warehouse_director','approve_warehouse_manager','view_refunds','add_refunds','view_distribution_refunds','add_distribution_refunds','view_warehouse_refunds','add_warehouse_refunds','approve_refunds','view_expenses','add_expenses','approve_expenses','view_reports','view_revenue','view_profit','view_stock_records','view_inventory_consistency','view_wholesale_invoices','view_warehouse_invoices','view_warehouse_approvals','view_imei_conflicts','view_cashdrawer','view_users','view_config','view_super_bin'
    ];
    if (rl === 'manager' || rl === 'branch manager') return [
      'view_dashboard','view_dashboard_cashier_assigned','view_dashboard_branch_comparison_assigned','view_pos','view_wholesale_pos','view_warehouse_pos','view_retail_price','view_wholesale_price','view_agent_price','view_sales','add_sales','view_products','view_distribution_products','view_warehouse_products','add_products','edit_products','view_inventory','edit_inventory','view_serialized_inventory','view_labels','view_purchases','add_purchases','add_wholesale_purchases','add_warehouse_purchases','edit_purchases','approve_purchases','view_transfers','add_transfers','add_wholesale_transfers','add_warehouse_transfers','edit_transfers','approve_transfers','view_adjustments','add_adjustments','add_wholesale_adjustments','add_warehouse_adjustments','edit_adjustments','approve_adjustments','view_suppliers','add_suppliers','edit_suppliers','view_customers','add_customers','edit_customers','view_finance_reconciliation','add_finance_reconciliation','approve_finance_reconciliation_manager','view_credit_control','approve_credit_manager','view_credit_repayment_approvals','view_approvals','approve_discount_sales','approve_retail_manager','approve_distribution_manager','approve_warehouse_manager','view_refunds','add_refunds','view_distribution_refunds','add_distribution_refunds','view_warehouse_refunds','add_warehouse_refunds','approve_refunds','view_expenses','add_expenses','approve_expenses','view_reports','view_revenue','view_profit','view_wholesale_invoices','view_warehouse_invoices','view_warehouse_approvals','view_imei_conflicts','view_cashdrawer','view_config'
    ];
    if (rl === 'cashier') return ['view_pos','view_wholesale_pos','view_warehouse_pos','view_retail_price','view_wholesale_price','view_agent_price','view_sales','add_sales','view_customers','view_finance_reconciliation','add_finance_reconciliation','view_credit_control','view_refunds','add_refunds','view_warehouse_refunds','add_warehouse_refunds','view_wholesale_invoices','view_warehouse_invoices','view_cashdrawer'];
    if (rl === 'inventory staff') return ['view_retail_price','view_wholesale_price','view_agent_price','view_products','view_distribution_products','view_warehouse_products','view_inventory','view_serialized_inventory','edit_inventory','view_labels','view_purchases','add_purchases','add_wholesale_purchases','add_warehouse_purchases','view_transfers','add_transfers','add_wholesale_transfers','add_warehouse_transfers','view_adjustments','add_adjustments','add_wholesale_adjustments','add_warehouse_adjustments','view_suppliers','view_wholesale_pos','view_warehouse_pos','view_warehouse_refunds','add_warehouse_refunds'];
  ...
  function canRemoveUser(u) {
    ...
    return String(u.role || '') !== 'SuperAdmin';
  }
  ...
  function startEdit(u) {
    ...
    setEditRemark('');
    const hasExplicitGrantConfig = Object.prototype.hasOwnProperty.call(existingGrants || {}, u.name);
    const effectiveSourceGrants = hasExplicitGrantConfig
      ? existingGrants?.[u.name]
      : defaultsForRole(u.role);
    const g = filterGrantsByTenantFlags(effectiveSourceGrants || [], settings).filter((key) => visibleGrantKeySet.has(key));
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          (async () => {
                            ...
                            const ok = await confirmDialog(`Remove user ${u.name}? The user will go to Super Bin.`);
                            if (!ok) return;
