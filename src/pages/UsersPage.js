...
function UsersPage() {
  ...
  const defaultsForRole = useCallback((r) => {
    ...
    if (rl === 'inventory staff') return ['view_retail_price','view_wholesale_price','view_agent_price','view_products','view_distribution_products','view_warehouse_products','view_inventory','view_serialized_inventory','edit_inventory','view_labels','view_purchases','add_purchases','view_transfers','add_transfers','view_adjustments','add_adjustments','view_suppliers','view_wholesale_pos'];
